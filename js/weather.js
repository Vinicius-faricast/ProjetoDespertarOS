...
const latitude = '-23.494656'
const longitude = '-47.5136'

const getCityUrl = `${baseUrl}locations/v1/cities/geoposition/search?apikey=${apiKey}&q=${latitude}%2C${longitude}&language=pt-br`;
...
export const getCityData = () => fetchData(getCityUrl);
